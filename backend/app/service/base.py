...
UpdateSchema = TypeVar("SchemaUpdate", bound=BaseModel)


class BaseService(Generic[Repository, InputShema, UpdateSchema, OutputSchema]):
    ...
    async def update(self, id: int, schema: UpdateSchema) -> OutputSchema:
